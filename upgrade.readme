...
Zeile 5-6: Als erstes wird der Googleserver angepingt, um zu prüfen ob eine Internetverbindung besteht. Besteht diese nicht, wird eine entsprechende Meldung in roter Schrift ausgegeben und das Script endet.
...
Alle Meldung außer der erfolgen im Terminal, außer der zenity-Warnung, dass das Paketsystem beschädigt ist und nicht repariert werden muss. Wenn das Script also als Daemon im Hintergrund läuft, wird der Benutzer nur in diesem Fall belästigt da er hier zwingend Hand anlegen muss.
